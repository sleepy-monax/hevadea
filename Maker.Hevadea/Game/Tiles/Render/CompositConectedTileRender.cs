...
namespace Maker.Hevadea.Game.Tiles.Render
{
    public class CompositConectedTileRender
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 position, TileConection connection)
        {
            ...
            DrawCorner(spriteBatch, connection.Left, connection.UpLeft, connection.Up, new Point(0, 0), new Point(0, 2), new Point(0, 3), new Point(2, 0),
                new Point(2, 2), (int)(position.X + 0), (int)(position.Y + 0));
            DrawCorner(spriteBatch, connection.Up, connection.UpRight, connection.Right, new Point(1, 0), new Point(1, 2), new Point(0, 2), new Point(3, 0),
                new Point(2, 2), (int)(position.X + 8), (int)(position.Y + 0));

            DrawCorner(spriteBatch, connection.Right, connection.DownRight, connection.Down, new Point(1, 1), new Point(1, 3), new Point(1, 2), new Point(3, 1),
                new Point(2, 2), (int)(position.X + 8), (int)(position.Y + 8));
            DrawCorner(spriteBatch, connection.Down, connection.DownLeft, connection.Left, new Point(0, 1), new Point(0, 3), new Point(1, 3), new Point(2, 1),
