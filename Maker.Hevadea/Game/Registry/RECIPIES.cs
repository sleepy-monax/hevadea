...
namespace Maker.Hevadea.Game.Registry
{
    public static class RECIPIES
    {
        ...
        public static void InitializeHandCraftedRecipe()
        {
            ...
            HandCrafted.Add(new Recipe(ITEMS.CraftingbenchItem, 1).AddCost(ITEMS.WoodStick, 4)
                .AddCost(ITEMS.WoodPlank, 4));
            HandCrafted.Add(new Recipe(ITEMS.FurnaceItem, 1, new RecipeCost(ITEMS.Stone, 8)));
        }
    }
}