...
using System.Linq;
using System.Text;
using Maker.Rise.Graphic.Path.Utility;
using Microsoft.Xna.Framework;

namespace Maker.Rise.Graphic.Path
{
    internal abstract class LineCapInfo
    {
        ...
        {
            _width = width;
            _xyBuffer = new Vector2[vertexCount];
            _indexBuffer = new short[polyCount * 3];
            _outlineBuffer = new short[vertexCount];
        }

        protected LineCapInfo (float width, Vector2[] xyBuffer, Vector2[] uvBuffer, short[] indexBuffer, short[] outlineBuffer)
        {
            _width = width;
            _xyBuffer = xyBuffer;
            _uvBuffer = uvBuffer;
    ...
    {
        private static readonly Vector2[] XYBuffer = new Vector2[] { new Vector2(0, -.5f), new Vector2(0, .5f) };
        private static readonly Vector2[] UVBuffer = new Vector2[] { new Vector2(1, 0), new Vector2(0, 0) };
    ...
    {
        private static readonly Vector2[] XYBuffer = new Vector2[] { new Vector2(-.5f, -.5f), new Vector2(-.5f, .5f) };
        private static readonly Vector2[] UVBuffer = new Vector2[] { new Vector2(1, 0), new Vector2(0, 0) };
        private static readonly short[] IndexBuffer = new short[] { };
        private static readonly short[] OutlineBuffer = new short[] { 0, 1 };
    ...
    {
        private static readonly Vector2[] XYBuffer = new Vector2[] { new Vector2(0, -.5f), new Vector2(-.5f, 0), new Vector2(0, .5f) };
        private static readonly Vector2[] UVBuffer = new Vector2[] { new Vector2(1, 0), new Vector2(.5f, 0), new Vector2(0, 0) };
    ...
    {
        private static readonly Vector2[] XYBuffer = new Vector2[] { new Vector2(0, -.5f), new Vector2(-.5f, -.5f), 
            new Vector2(0, 0), new Vector2(-.5f, .5f), new Vector2(0, .5f) };
        private static readonly Vector2[] UVBuffer = new Vector2[] { new Vector2(1, 0), new Vector2(1, 0),
            new Vector2(.5f, 0), new Vector2(0, 0), new Vector2(0, 0) };
    ...
    {
        private static readonly Vector2[] XYBuffer = new Vector2[] { new Vector2(1f, -.5f), new Vector2(1f, -.75f), 
            new Vector2(-.5f, 0), new Vector2(1f, .75f), new Vector2(1f, .5f) };
        private static readonly Vector2[] UVBuffer = new Vector2[] { new Vector2(1, 0), new Vector2(1, 0),
            new Vector2(.5f, 0), new Vector2(0, 0), new Vector2(0, 0) };
