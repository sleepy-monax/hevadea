...
{
    public sealed class Health : Component, IEntityComponentSaveLoad
    {
        ...
        public double NaturalregenerationSpeed { get; set; } = 0.5;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                Entity.GetComponent<Move>()?.Do(_knckbckX, _knckbckY, Entity.Facing);
                _knckbckX *= 0.9f;
                _knckbckY *= 0.9f;
            }
        ...
        public void Hurt(Entity entity, float damages, bool knockback = true)
        {
            if (knockback)
            {
                var dir = new Vector2(Entity.X - entity.X, Entity.Y - entity.Y);
